    ...
    return (
        <div className={style.projectsBlock}>
            ...
            <div className={style.projects}>
                <Project style={social} title={'Social network'} description={'New smart of social network projects'}/>
                <Project style={todolist} title={'Todolist'} description={'Todolist - main project for create CRUD architecture'}/>
                <Project style={futureProj} title={'Friday project'} description={'Someone project in the future'}/>
                <Project style={nbaStat} title={'NBA Statistics'} description={'More statistics about professional basketball game from NBA'}/>
            </div>
        </div>
    );
}